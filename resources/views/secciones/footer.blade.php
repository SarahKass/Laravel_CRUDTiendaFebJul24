        ...
        <div class="col-12 col-md-6">
            ...
            <div class="row">
              <div class="col-6">
                <div class="address-wrapper">
                  <h4 class="mb-3 h5 text-white">Oficina central</h4>
              ...
              <div class="col-6">
                <div class="address-wrapper">
                  <h4 class="mb-3 h5 text-white">Sucursal</h4>
                  <address class="mb-3 fs-7 text-light opacity-75">
          ...
          <section>
            <div class="row">
              <div class="col-6">
                <div class="address-wrapper">
                  <h4 class="mb-3 h5 text-white">Depósito</h4>
              ...
              <div class="col-3">
                <div class="social-media-wrapper">
                  <h4 class="mb-3 h5 text-white">Contactos</h4>
                  <ul class="m-0 list-unstyled d-flex justify-content-start gap-4">
                    <li>
                      <a href="https://facebook.com/" class="link-opacity-75 link-opacity-100-hover link-light">
                    ...
                    <li>
                      <a href="https://twitter.com/" class="link-opacity-75 link-opacity-100-hover link-light">
                    ...
                    <li>
                      <a href="https://instagram.com/" class="link-opacity-75 link-opacity-100-hover link-light">
    ...
    <div class="container border-top border-dark py-3 py-md-5 py-xl-8 py-xxl-10">
      <div class="row gy-3 align-items-lg-center">
        <div class="col-12 col-lg-6 order-1 order-lg-0">
          <div class="copyright-wrapper d-block mb-1 fs-7 text-light opacity-75 text-center text-lg-start">
            &copy; 2024. Todos los derechos reservados. Sarai AC (●'◡'●).
          </div>
          <div class="credit-wrapper d-block fs-9 text-light opacity-75 text-center text-lg-start">
            Built by<a href="https://bootstrapbrain.com/" class="link-light text-decoration-none">
              Laravel</a> with <span class="text-primary">&#9829;</span>
          </div>
        </div>
        <div class="col-12 col-lg-6">
          <div class="link-wrapper">
            <ul class="m-0 list-unstyled d-flex justify-content-center justify-content-lg-end gap-2 gap-md-3">
              <li>
                <a href="#!" class="link-opacity-75 link-underline-opacity-0 link-opacity-100-hover link-underline-opacity-100-hover link-offset-1 link-light fs-8 d-flex align-items-center pe-2 pe-md-3 bsb-sep bsb-sep-border">
                  Envío
                </a>
              </li>
              <li>
